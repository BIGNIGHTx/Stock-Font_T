    ...
    <div className="min-h-screen bg-[#F3F5F9] font-sans flex flex-col items-center">
      <div className="w-full max-w-[1280px] p-4 md:p-6 text-slate-700 animate-fade-in pb-10">
        ...
        {currentView === 'products' ? (
          ...
          <div className="text-center mb-5 max-w-3xl mx-auto pt-1 animate-fade-in relative">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 bg-white">
                    ...
                    <h3 className="text-base font-display font-bold text-slate-900 mb-0.5">
                      {cat.name}
                    </h3>
                    <p className="text-xs font-body text-slate-500 font-light">
                      {cat.thai}
                    </p>
                  </div>
                </div>
